...
sprite_set_offset(spr_player_a,30,50)
sprite_set_offset(spr_player_b,30,50)
scr_trail (1, 0, 20)
...
draw_sprite_ext(spr_ufo_a,1,x,y,image_xscale,image_yscale,angle*gravdir+angleplus,global.col1,image_alpha)
draw_sprite_ext(spr_ufo_b,1,x,y,image_xscale,image_yscale,angle*gravdir+angleplus,global.col2,image_alpha)
